...
*/
const tom = 'Tom'
const firstTomb = 'hanks'
const secondTom = 'cruise'
const myFavoriteTom = `o nome que eu mais gosto é ${firstTomb}`
...
*/
// console.log(winterMessage.slice(4,5))
...
const realBestMovie = 'E o Oscar de melhor Moonlight vai para: "La la land"!'
