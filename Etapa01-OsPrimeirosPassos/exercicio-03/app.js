...
*/
const foodsInfo = `Até aqui, o  array brazilianFoods possui ${brazilianFoods.push()} itens: ${brazilianFoods[0]}, ${brazilianFoods[1]} e ${brazilianFoods[2]}.`
...
*/
let dogNames2 = dogNames.join(', ')
// console.log(dogNames2)
...
*/
dogNames.push('Nina')
const initials = `${dogNames[0][0]}${dogNames[3][0]}`
