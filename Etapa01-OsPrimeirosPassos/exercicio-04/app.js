...
*/
const my3FavoriteTVShows = ['got', 'bad', 'lucifer']
const sentence = `Minhas 3 séries favoritas são: ${my3FavoriteTVShows.join(', ')}.`.replace(', l', ' e L') 
...
/*
  ...
  - Exiba no console um boolean indicando se o array de séries que você criou  
    possui 3 itens.
*/
// console.log(my3FavoriteTVShows.push() === 3)
...
// console.log(`A string que a "typeSentence" armazena tem mais de 39 caracteres? ${typeSentence.length > 39}.`)
...
// console.log(`Todos os ${falsyValues.push()} itens do array "falsyValues" são falsy. Inclusive o ${falsyValues[2]}.`)
