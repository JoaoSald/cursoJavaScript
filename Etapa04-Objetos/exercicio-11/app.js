...
/*
  ...
  - Você sabe por que isso aconteceu? TEM UM ESCOPO LOCAL
...
run : function()
{
  ...
  if(this.isRunning !== true){
    console.log(`${car.name} parado`)
  }else{
    console.log(`${car.name} em movimento`)
...
{
  console.log(`O ${car.name} está disponível nas cores ${car.colors[0]}, ${car.colors[1]} e ${car.colors[2]} `)
}
}
