...
const divDoisOuTres = num => num%2 === 0 || num%3 === 0
const newArray = numbers.filter(divDoisOuTres)
...
const arrNameSilaba = ['jo', 'ao']
//minha resolução
//for(i=0; i < arrNameSilaba.length; i++){
//   let teste = 'P'+arrNameSilaba[0]+'P'+arrNameSilaba[1]
   //console.log('nome => '+teste)
//}
//correcao
const nameInPlanguage = arrNameSilaba.reduce((acc, sylable)=>`${acc}P${sylable}`, ' ')
